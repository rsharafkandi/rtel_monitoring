...
while [ True ]; do
   ...
   case "$1" in
     ...
     "--help" )
        ...
        echo
        echo "   This script runs a query against mysql database to get count of registered portability requests of today (or yesterday) depending on the"
        echo "value of --when parameter (by default it is today)."
        echo
        exit 0
        ;;
     * )
